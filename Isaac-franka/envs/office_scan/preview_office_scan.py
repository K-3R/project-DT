...
# Edit 2026-08-31
# ======================================
# [ver] preview_office_scan.py 2026-08-31-r3  (ascii-only console/comments)
# r3: env 격리 -- envs/office/preview_office.py 의 사본에 scene import 만
#     office_scan_scene 으로 교체 (구 r2 = _overlay runpy wrapper).
#     확정값(scan/배치/색/조명) = office_scan_scene.py 기본값이 정본
r"""
...
사용
    CUDA_VISIBLE_DEVICES=3 isaaclab.sh -p preview_office_scan.py --headless
    CUDA_VISIBLE_DEVICES=3 isaaclab.sh -p preview_office_scan.py --headless \
